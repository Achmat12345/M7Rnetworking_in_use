...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'Twitter',
      href: 'https://twitter.com/m7rnetworking',
      icon: (
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/company/m7rnetworking',
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/m7rnetworking',
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      href: 'https://youtube.com/@m7rnetworking',
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-6 max-w-xs">
                Build Identity. Tell Your Story. Create Independence. 
                Empowering creators with AI-powered tools and a vibrant marketplace.
              </p>
                ...
                <ul className="space-y-3">
                  {section.links.map((link) => (
                    <li key={link.name}>
                      <Link
                        to={link.href}
                        className="text-gray-600 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400 transition-colors duration-200 text-sm"
                      >
                        {link.name}
                      </Link>
                    </li>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 py-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-6 mb-4 md:mb-0">
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                © {currentYear} M7RNetworking. All rights reserved.
              </p>
              <div className="flex space-x-4">
                <Link
                  to="/privacy"
